...
<head>
    ...
    <title>Cuisine • India</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Sura:wght@400;700&family=Playfair+Display:ital,wght@0,400;0,700;1,400&family=Rozha+One&display=swap" rel="stylesheet">
...
<body>
    ...
    <section class="country-hero">
        <div class="hindi-background">भारतीय व्यंजन</div>
        <div class="hero-content">
            <h1 class="hero-main-title">India</h1>
            <p class="hero-subtitle">The Spice Route</p>
            <p class="hero-desc">Experience a symphony of aromatic spices, vibrant colors, and rich cultural heritage in every bite.</p>
        </div>
    </section>
            ...
            <?php foreach ($recipes as $row): 
                ...
                if (!empty($row['image'])) {
                    if (strpos($row['image'], '/') !== false) {
                        ...
                        $cardImg = '../cuisine/India Image/' . rawurlencode($row['image']);
                    }
                } else {
