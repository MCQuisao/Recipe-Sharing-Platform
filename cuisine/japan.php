...
try {
    // Dynamically retrieve Japanese recipes from database table rows
    $query = "SELECT r.*, 
    ...
    WHERE LOWER(c.name) = 'japan' OR LOWER(c.name) = 'japanese'";
...
<head>
    ...
    <title>Cuisine • Japan</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Sura:wght@400;700&family=Playfair+Display:ital,wght@0,400;0,700;1,400&family=Zen+Antique+Soft&display=swap" rel="stylesheet">
...
<body>
    ...
    <header class="nav-bar">
        <div class="logo">
            <a href="../main-page/mainpage.php">
                <img src="../images/recipe-logo-removebg-preview.png" alt="Logo" class="logo-img">
            </a>
    ...
    <section class="country-hero">
        <div class="kanji-background">日本料理</div>
        <div class="hero-content">
            <h1 class="hero-main-title">Japan</h1>
            <p class="hero-subtitle">The Art of Umami</p>
            <p class="hero-desc">Discover the harmony of seasonal ingredients, traditional techniques, and modern innovation.</p>
        </div>
    </section>
            ...
            <?php foreach ($recipes as $row): 
                if (!empty($row['image'])) {
                    if (strpos($row['image'], '/') !== false) {
                        ...
                        $cardImg = '../cuisine/Japan Image/' . rawurlencode($row['image']);
                    }
                } else {
